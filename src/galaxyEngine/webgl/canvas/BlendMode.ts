...
export class BlendMode {
    ...
    static TOINT: any = { "normal": 0, "add": 1, "multiply": 2, "screen": 3, 
                            "overlay": 4, "light": 5, "mask": 6, "destination-out": 7, 
                            "lighter": 1, "normalex": 8, "addex": 9 };
    ...
    static NORMALEX: string = "normalex";				//8
    static ADDEX: string = "addex";					    //9
    ...
    static _init_(gl: WebGLContext): void {
        BlendMode.fns = [BlendMode.BlendNormal, BlendMode.BlendAdd, BlendMode.BlendMultiply, 
                            BlendMode.BlendScreen, BlendMode.BlendOverlay, BlendMode.BlendLight, 
                            BlendMode.BlendMask, BlendMode.BlendDestinationOut,
                            BlendMode.BlendNormalEx, BlendMode.BlendAddEx];

        BlendMode.targetFns = [BlendMode.BlendNormalTarget, BlendMode.BlendAddTarget, 
                                BlendMode.BlendMultiplyTarget, BlendMode.BlendScreenTarget, 
                                BlendMode.BlendOverlayTarget, BlendMode.BlendLightTarget, 
                                BlendMode.BlendMask, BlendMode.BlendDestinationOut,
                                BlendMode.BlendNormalEx, BlendMode.BlendAddEx];
    }
    ...
    static BlendNormalEx(gl: WebGLRenderingContext): void {
        WebGLContext.setBlendFunc(gl, gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA);
    }
    ...
    static BlendAddEx(gl: WebGLRenderingContext): void {
        WebGLContext.setBlendFunc(gl, gl.SRC_ALPHA, gl.ONE);
    }
